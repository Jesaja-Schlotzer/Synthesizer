...
public class MatlabChart {
    ...
    public void legend(String position) {
        ...
        if (position.equalsIgnoreCase("northoutside")) {
            legend.setPosition(RectangleEdge.TOP);
            chart.addLegend(legend);
        } else if (position.equalsIgnoreCase("eastoutside")) {
            legend.setPosition(RectangleEdge.RIGHT);
            chart.addLegend(legend);
        } else if (position.equalsIgnoreCase("southoutside")) {
            legend.setPosition(RectangleEdge.BOTTOM);
            chart.addLegend(legend);
        } else if (position.equalsIgnoreCase("westoutside")) {
